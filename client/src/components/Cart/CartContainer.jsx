    ...
    <>
      <div className="flex items-center justify-between">
        <div className="flex flex-col items-start">
          <small
            className="flex items-center gap-1 bg-zomato-300 rounded-md text-white"
            onClick={toggle}
          >
        ...
        <>
          {isOpen && (
            <div className="w-full overflow-y-scroll h-48 bg-white z-20 p-2 bottom-14 px-3 fixed">
              <div className="flex items-center bg-zomato-200 justify-between md:px-20 rounded-lg">
              ...
              <div className="flex flex-col gap-2 md:px-20 text-zomato-500">
                {cart.map((food) => (
          ...
          <div className="fixed w-full bg-blue-50 z-10 p-2 px-3 bottom-0 mx-auto lg:px-20">
